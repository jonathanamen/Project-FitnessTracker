...
class LowPassFilter:
    def low_pass_filter(
        ...
        data_table,
        col,
        sampling_frequency,  # JA: time (freq) between each timestamp of your records
        # JA: for this project we set it at 200 ms
        cutoff_frequency,  # JA: freq we want to set our filter to
        # JA: we set this and play with it until we get good results
        order=5,
        phase_shift=True,
    ):
